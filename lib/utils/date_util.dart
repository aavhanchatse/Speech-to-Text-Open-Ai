...
class DateUtil {
  ...
  static String parseServerFormatDateTimeFromString(String date) {
    var splitTime = date.split("/");
    return "${splitTime[2]}-${splitTime[1]}-${splitTime[0]}T24:00:00.000Z";
  }
...
//    return getDisplayFormatDateTime(dateTime);
    ...
    if (timeDifference < 24) {
      if (timeDifference <= 0)
        return '${differenceDuration.inMinutes} Minute Ago';
